...
@section('container')
    ...
    @if (session()->has('success'))
        ...
        @endif
    <a href="/dashboard/genre/create" class="btn btn-dark btn-sm mb-2">create data</a>
               ...
               <tr>
                ...
                <td>
                    <form method="post" action="/dashboard/genre/{{ $genre->slug }}">
                        ...
                        <a href="/dashboard/genre/{{ $genre->slug }}/edit" class="badge bg-warning"><span data-feather="edit"></span></a>
